...
DEFAULT_ROLES = {
    ...
    "accounts_payable": {
        ...
        "permissions": [
            "dashboard.view", "dashboard.procurement",
            "buying.view", "buying.create", "buying.reports", "parties.view", "parties.manage",
            "expenses.view", "expenses.create", "matching.view", "matching.approve",
    ...
    "tax_accountant": {
        ...
        "permissions": [
            "dashboard.view", "dashboard.financial",
            "taxes.view", "taxes.manage", "accounting.view", "accounting.create_journal_entry", "accounting.post_journal_entry",
            "treasury.view", "treasury.create", "reports.view", "reports.financial", "currencies.view",
            "sales.view", "buying.view", "branches.view", "notifications.view", "finance.accounting_read",
        ]
    },
    "cost_accountant": {
