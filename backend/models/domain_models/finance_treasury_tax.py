...
class TreasuryTransaction(ModelBase):
    ...
    exchange_rate: Mapped[Decimal | None] = mapped_column(Numeric(18, 6), server_default=sa_text("1.0"))
...
class BankReconciliation(ModelBase):
    ...
    start_balance: Mapped[Decimal | None] = mapped_column(Numeric(18, 4), default=0)
    end_balance: Mapped[Decimal | None] = mapped_column(Numeric(18, 4), default=0)
...
class BankStatementLine(ModelBase):
    ...
    debit: Mapped[Decimal | None] = mapped_column(Numeric(18, 4), default=0)
    credit: Mapped[Decimal | None] = mapped_column(Numeric(18, 4), default=0)
    balance: Mapped[Decimal | None] = mapped_column(Numeric(18, 4), default=0)
...
class TaxRate(ModelBase):
    ...
    rate_value: Mapped[Decimal | None] = mapped_column(Numeric(10, 4), default=0)
...
class TaxReturn(ModelBase):
    ...
    taxable_amount: Mapped[Decimal | None] = mapped_column(Numeric(18, 4), default=0)
    tax_amount: Mapped[Decimal | None] = mapped_column(Numeric(18, 4), default=0)
    penalty_amount: Mapped[Decimal | None] = mapped_column(Numeric(18, 4), default=0)
    interest_amount: Mapped[Decimal | None] = mapped_column(Numeric(18, 4), default=0)
    ...
    exchange_rate: Mapped[Decimal | None] = mapped_column(Numeric(18, 6), default=1)
...
class TaxRegime(ModelBase):
    ...
    default_rate: Mapped[Decimal | None] = mapped_column(Numeric(10, 4), default=0)
...
class BranchTaxSetting(ModelBase):
    ...
    custom_rate: Mapped[Decimal | None] = mapped_column(Numeric(10, 4))
