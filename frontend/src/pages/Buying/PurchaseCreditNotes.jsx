...
function PurchaseCreditNotes() {
    ...
    const handleCreate = async () => {
        ...
        if (!form.lines.length || form.lines.every(l => !l.unit_price)) return showToast(t('buying.credit_notes.line_required', 'warning'))
        try {
            setSaving(true)
                        ...
                        <div style={{ padding: 20 }}>
                            ...
                            <div style={{ marginTop: 20, display: 'flex', justifyContent: 'flex-end' }}>
                                <div style={{ minWidth: 250, background: 'var(--card-bg)', padding: 16, borderRadius: 8 }}>
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}><span>{t('buying.credit_notes.tax')}:</span><strong>{summaryTax != null ? formatNumber(summaryTax) : '—'} {currency}</strong></div>
                                    <hr />
