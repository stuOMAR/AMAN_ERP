...
const PERMISSION_ALIASES = {
    ...
    'admin':            ['admin.users', 'admin.roles', 'admin.companies', 'admin.branches', 'admin.account_classifications', 'admin.cache', 'admin.credentials', 'admin.recurring', 'admin.security', 'system.admin'],
    ...
    'approvals.manage': ['approvals.view', 'approvals.create', 'approvals.edit', 'approvals.action', 'approvals.approve'],
